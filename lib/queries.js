 ...
 *     contained.
 * @returns {Promise<LocationDetails[] | null>} The locations that contain the
 *     right amount of locations.
 */
 ...
 * @returns {Promise<string[]>} The URIs of the contained locations.
 */
